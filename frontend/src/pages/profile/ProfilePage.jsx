							...
							<div className='flex flex-col gap-4 mt-14 px-4'>
									...
									{user?.link && (
										<div className='flex gap-1 items-center '>
											<>
												...
												<a
													href='https://www.linkedin.com/in/khushi-pandey-498a65237/'
													target='_blank'
													rel='noreferrer'
								...
								<div className='flex gap-2'>
									<div className='flex gap-1 items-center'>
										...
										<span className='text-slate-500 text-s'>Following</span>
									</div>
									<div className='flex gap-1 items-center'>
										<span className='font-bold text-s'>{user?.followers.length}</span>
										<span className='text-slate-500 text-s'>Followers</span>
									</div>
								</div>
							</div>
